...
contract CompManager is CompManagerStorage {
    ...
    function _transferToken(address token, address dst, uint amount) {
    ...
    // Will need to check compSupplierIndex, compBorrowerIndex, compAccrued against the comptroller for first call on each user in the new contract.
